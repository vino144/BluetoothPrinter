...
public class Main2Activity extends AppCompatActivity  implements Runnable{
        ...
        mScan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View mView) {
                ...
                if (mBluetoothAdapter == null) {
                    Toast.makeText(Main2Activity.this, "Message1", Toast.LENGTH_SHORT).show();
                } else {
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        ListPairedDevices();
                        Intent connectIntent = new Intent(Main2Activity.this,
        ...
        switch (mRequestCode) {
            case REQUEST_CONNECT_DEVICE:
                if (mResultCode == Activity.RESULT_OK) {
                    ...
                    if (mExtra.getString("DeviceAddress")!=null){
                        ...
                        if(mDeviceAddress!=null&&mDeviceAddress.length()>0){
                            ...
                            if (mBluetoothDevice!=null) {
                                mBluetoothConnectProgressDialog = ProgressDialog.show(Main2Activity.this,
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(Main2Activity.this, "DeviceConnected", Toast.LENGTH_SHORT).show();
        }
    };
